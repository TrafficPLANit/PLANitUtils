...
public class TransferZoneGroupUtils {
   ...
   */
  public static <G extends TransferZoneGroup, Z extends TransferZone> void updateTransferZoneMapping(
      Iterable<G> transferZoneGroups, Function<Z, Z> zoneToZoneMapping, boolean removeMissingMappings) {
