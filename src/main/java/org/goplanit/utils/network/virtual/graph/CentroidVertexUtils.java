...
public class CentroidVertexUtils {
   ...
   * @param centroidToCentroidMapping to use should contain original centroid as used on current centroid vertex and
   *                                  then the value to replace it
   * @param removeMissingMappings when true if there is no mapping, the parent centroid is nullified, otherwise it
   *                              is left in-tact
   */
