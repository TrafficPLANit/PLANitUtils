...
public interface ConjugateConnectoidNodes extends ManagedGraphEntities<ConjugateConnectoidNode> {
   ...
   */
  @Override
  public abstract ConjugateConnectoidNodes shallowClone();
   ...
   */
  @Override
  public abstract ConjugateConnectoidNodes deepCloneWithMapping(
          BiConsumer<ConjugateConnectoidNode, ConjugateConnectoidNode> mapper);
}
