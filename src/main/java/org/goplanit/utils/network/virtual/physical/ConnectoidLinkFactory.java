...
public interface ConnectoidLinkFactory extends GraphEntityFactory<ConnectoidLink>{
  ...
  /**
   * Create new connectoid link from a specified connectoid to all centroids of the zones this connectoid has registered as access zone.
   * 
   ...
   * @return newly created connectoid link (reference vertices not yet aware of connection these have to be added afterwards)
   */
